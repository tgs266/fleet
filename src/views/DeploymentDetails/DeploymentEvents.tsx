...
interface IAppEventsState {
    events: Event[];
    ws: WebSocket;
    page: number;
}

interface IDeploymentEventProps {
    deploymentName: string;
    namespace: string;
}

class DeploymentEvents extends React.Component<IDeploymentEventProps, IAppEventsState> {
    // eslint-disable-next-line react/static-property-placement
    static contextType = NavContext;

    constructor(props: IDeploymentEventProps) {
        super(props);
    ...
    render() {
        return (
            <TitledCard title="Events" style={{ margin: '1em' }}>
